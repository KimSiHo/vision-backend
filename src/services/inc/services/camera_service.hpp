...
public:
    ...
    void switch_to_camera();  // 연결된 카메라 전환
    void switch_to_test();  // 원격 비디오 샘플로 전환

    GstElement* get_inference_appsink() { return inference_appsink_; }
...
private:
    ...
    static gboolean on_autoplug_continue(GstElement *bin, GstPad     *pad, GstCaps    *caps, gpointer    user_data);
    ...
    GstElement *uri_src_{nullptr}, *uri_queue_{nullptr}, *uri_conv_{nullptr}, *uri_caps_scaled_{nullptr}, *uri_conv2_{nullptr}, *uri_caps_scaled2_{nullptr}, *audio_fakesink_{nullptr};
    GstElement *src_selector_{nullptr}, *tee_{nullptr};

    GstElement *front_queue_{nullptr}, *front_conv_{nullptr}, *front_caps_{nullptr}, *uri_videorate_{nullptr}, *uri_caps_framerate_{nullptr}, *front_shm_{nullptr};
